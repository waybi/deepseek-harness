...
The menu, Modal, and buttons retain their existing structure and design tokens. Session deletion is a separate capability ([session delete](2026-08-18-session-delete.md)) and remains outside this decision.
