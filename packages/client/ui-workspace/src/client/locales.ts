...
export const zh = {
  ...
  'delete.session': '删除会话',
  'delete.session.desc': '将永久删除“{name}”及其对话记录。子代理会话也会一并删除。',
...
export const en = {
  ...
  'delete.session.desc': 'This permanently deletes “{name}” and its conversation history. Child conversations are also deleted.',
