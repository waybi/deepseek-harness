...
- Destructive folder removal remains a separate, absent capability; Workspace registration deletion never substitutes for it or for Session deletion ([decision](../../../.agents/notes/implemented/feature/2026-07-27-workspace-registration-deletion.md)). Session deletion ships separately ([session delete](../../../.agents/notes/implemented/feature/2026-08-18-session-delete.md)).
