...
- 破坏性的文件夹移除仍是独立且尚未提供的功能；删除 Workspace 注册记录绝不能替代它，也不能替代会话删除（参见[决策记录](../../../.agents/notes/implemented/feature/2026-07-27-workspace-registration-deletion.md)）。会话删除另行落地（[会话删除](../../../.agents/notes/implemented/feature/2026-08-18-session-delete.md)）。
